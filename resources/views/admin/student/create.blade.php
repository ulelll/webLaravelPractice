    ...
    <section class="bg-yellow dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="/admin/students/store" method="post">
                ...
                <button type="submit"
                    class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center bg-yellow-500 rounded-lg focus:ring-4 focus:ring-yellow-200 dark:focus:ring-yellow-600 hover:bg-yellow-800">
                    Add Student
                </button>
            </form>
        </div>
